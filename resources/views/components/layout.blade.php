    ...
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <div class="flex-row my-3 my-md-0">
          ...
          <a class="btn btn-sm btn-success mr-2" href="/create_post">Create Post</a>
        ...
        <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
          ...
          <div class="row align-items-center">
            <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
              ...
              @error('loginusername')
                <p class="alert alert-danger alert-dismissible " style="margin-top: 2px; font-size: 12px">{{$message}}</p>
              @enderror
            </div>
            <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
              <input name="loginpassword" class="form-control form-control-sm input-dark" type="password" placeholder="Password" />
              @error('loginpassword')
                <p class="alert alert-danger alert-dismissible fade show" style="margin-top: 2px; font-size: 12px;">{{$message}}</p>
              @enderror
            </div>
